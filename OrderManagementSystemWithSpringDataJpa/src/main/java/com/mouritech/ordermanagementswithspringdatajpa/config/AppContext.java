package com.mouritech.ordermanagementswithspringdatajpa.config;
...
@ComponentScan({
	"com.mouritech.ordermanagementswithspringdatajpa"
})
@EnableJpaRepositories(basePackages = "com.mouritech.ordermanagementswithspringdatajpa.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mouritech.ordermanagementswithspringdatajpa.entity"
		});
