...
@ComponentScan({
	"com.mouritech.ordermanagementsystemwithrestcontroller"
})
@EnableJpaRepositories(basePackages = "com.mouritech.ordermanagementsystemwithrestcontroller.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mouritech.ordermanagementsystemwithrestcontroller.entity"
		});
